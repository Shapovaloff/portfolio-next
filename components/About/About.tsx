...
const aboutList = [
  {
    text: 'Создаю продуманные интерфейсы на React и Next.js, которые работают быстро и понятно пользователю.',
  },
  {
    type: 'experience',
    text: 'Опыт',
  },
  { text: 'Умею работать в команде и эффективно взаимодействовать с дизайнерами, бэкендом и продактом.' },
  { text: 'Развиваю навыки через практику: разбираю архитектуру чужих проектов и пробую новые решения в своих pet-проектах.' },
  { text: 'Есть опыт менторства и управления небольшой командой разработчиков.' },
];
